...
export default function Home() {
  ...
  const jsonLd = {
    ...
    "@type": "LocalBusiness",
    "name": "SULTAN Travel and Tourism Company LLC",
    "image": "https://two-year-residency-visa.vercel.app/assets/images/dubai-hero.jpg",
    ...
    "sameAs": [
      "https://www.tiktok.com/@dubai.pro.service7",
      "https://t.me/Dubaifreelancevisa07",
      "https://wa.me/971589149609"
    ]
  };

  // --- GLOBAL STATE: FORM PRE-FILL ---
  const [prefilledData, setPrefilledData] = useState({
    nationality: "Pakistan",
    category: ""
  });
  ...
  return (
    <>
      ...
      <main className="relative bg-white selection:bg-[#B38B59] selection:text-[#0F172A] antialiased">
        ...
        {/* 01. HERO SEQUENCE */}
        <div className="border-b border-black/[0.02]">
          <Hero onStartClick={scrollToApply} />
        </div>
        ...
        <footer className="relative bg-[#0F172A] pt-24 md:pt-32 pb-12 px-6 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 md:gap-20 mb-20">
              <div>
                <div className="flex flex-col mb-10">
                  <span className="text-3xl font-heading font-black tracking-tighter text-white leading-none uppercase">SULTAN</span>
                  <span className="text-[10px] tracking-[0.5em] uppercase text-[#B38B59] font-bold mt-2">Travel and Tourism LLC</span>
                </div>
                <p className="text-white/40 font-body text-sm max-w-sm leading-relaxed mb-10 uppercase tracking-widest">
                  DUBAI'S PREMIER RESIDENCY CONSULTANCY. TRANSFORMING GLOBAL MOBILITY SINCE 2024.
                </p>
                <div className="flex gap-8">
            ...
            <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-end gap-12">
              ...
              <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="flex flex-col items-start md:items-end gap-3 group">
                 <span className="text-[9px] font-black uppercase tracking-[0.4em] text-white/20 group-hover:text-[#B38B59] transition-colors">Digital Experience Engineered By</span>
                 <div className="flex items-center gap-6">
                    <a href="https://www.linkedin.com/in/ahmed-touqeer-4105503a7" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-white/5 px-5 py-3 rounded-sm border border-white/5 hover:bg-white/10 transition-all group/link shadow-xl">
                      <span className="text-[11px] font-heading font-black text-white tracking-widest uppercase">Ahmed Touqeer</span>
                      <ExternalLink size={12} className="text-[#B38B59] group-hover/link:translate-x-0.5 group-hover/link:-translate-y-0.5 transition-transform" />
                    </a>
                    <a href="https://wa.me/923137047329" target="_blank" className="flex items-center gap-3 text-white/40 hover:text-white transition-colors">
                      <MessageCircle size={14} className="text-[#B38B59]" />
                      <span className="text-[10px] font-bold uppercase tracking-widest">+92 313 7047329</span>
                    </a>
                 </div>
